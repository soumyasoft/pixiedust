                    ...
                    <table align="center" border="0" cellpadding="0" cellspacing="0" height="100%" width="100%">
                        <tr>
                            <td align="center" valign="top" bgcolor="#EFEFEF"><table class="contenttable" border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="#ffffff" style="border-width: 8px; border-style: solid; border-collapse: separate; border-color:#ececec; margin-top:40px; font-family:Arial, Helvetica, sans-serif">
                                    ...
                                    <tr>
                                        <td class="tablepadding" style="padding:5px; padding-left:36px; font-size:14px; line-height:20px;"><h3>Dear {{ $name }},</h3></td>
                                    </tr>
                                    <tr>
                                        <td class="tablepadding" style="border-top:1px solid #eaeaea;border-bottom:1px solid #eaeaea;padding:13px 20px;"><table width="100%" align="center" cellpadding="0" cellspacing="20" border="0">
                                                <tbody>
                                                    <span>You have registered successfully.Your login credential as follows. </span>
                                                    </p>
                                                    <tr>
                                                        <td width="21%" style="font-size:13px; font-family:Arial, Helvetica, sans-serif; color:#676767"><strong><span style="color:#707070">Email ID :</span></strong></td>
                                                        <td width="79%" align="left" style="font-size:14px; font-family:Arial, Helvetica, sans-serif; color:#676767"><span style="color: #707070">{{ $email }}</span></td>
                                                    </tr>
                                                    <tr>
                                                        <td style="font-size:13px; font-family:Arial, Helvetica, sans-serif; color:#676767"><strong>Password :</strong></td>
                                                        <td align="left" style="font-size:13px; font-family:Arial, Helvetica, sans-serif; color:#676767">{{ $password }}</td>
                                                    </tr>
